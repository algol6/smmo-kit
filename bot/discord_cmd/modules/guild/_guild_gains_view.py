...
class GuildGainsView(discord.ui.View):
    def __init__(self):
        self.TITLE = ("Celestial","Legendary","Epic","Elite","Rare")
    ...
    async def create_embed(self):
        ...
        for count in range(5):
            for i,g in enumerate(self.season_lb[(25*self.current_page)+count*5:(25*self.current_page)+5+(count*5)]):
            ...
            emb.add_field(name=self.TITLE[count] if self.current_page==0 else "",
                        value=msg,
                        inline=False)
            msg = ""
    ...
    @discord.ui.button(label="<", style=discord.ButtonStyle.primary,custom_id="prev-gain-btn")
    ...
    @discord.ui.button(label=">", style=discord.ButtonStyle.primary,custom_id="next-gain-btn")
